            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Slider-2</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section dashboard">
                ...
                while ($row = mysqli_fetch_array($run)) {
                    ...
                    <div>
                        ...
                        <a href="delete-slider_two.php?id=<?php echo $a; ?>" class="btn btn-danger">Delete</a>
                ...
                if (isset($_POST["submit"])) {
                    ...
                    $query = "insert into slider_two(slider2) values ('$image_name')";
                    $run = mysqli_query($conn, $query);
                    if ($run) {
