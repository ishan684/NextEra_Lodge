            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Slider-4</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section dashboard">
                ...
                while ($row = mysqli_fetch_array($run)) {
                    ...
                    <div>
                        ...
                        <a href="delete-slider_four.php?id=<?php echo $a; ?>" class="btn btn-danger">Delete</a>
                ...
                if (isset($_POST["submit"])) {
                    ...
                    $query = "insert into slider_four(slider4) values ('$image_name')";
                    $run = mysqli_query($conn, $query);
                    if ($run) {
