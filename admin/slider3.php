        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Slider-3</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section dashboard">
                ...
                while ($row = mysqli_fetch_array($run)) {
                    ...
                    ?>
                    <div>
                        <img src="../images/<?php echo $b ?>" alt="img-thumbnail " height="300px" width="500px">
                    </div>
                    <br>
                    <div>

                        <a href="delete-slider_three.php?id=<?php echo $a; ?>" class="btn btn-danger">Delete</a>
                ...
                if (isset($_POST["submit"])) {
                    ...
                    $query = "insert into slider_three (slider_three) values ('$image_name')";
                    $run = mysqli_query($conn, $query);
                    if ($run) {
