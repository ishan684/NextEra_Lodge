...
if (!isset($_SESSION['username'])) {
    ...
    <body data-spy="scroll" data-target="#templateux-navbar" data-offset="200">
                ...
                <div class="collapse navbar-collapse" id="templateux-navbar-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><span
                                    class="btn btn-primary text-white font-weight-bold" data-toggle="modal"
                                    data-target="#reservation-form">Reserve Now</span></a>
                        </li>
                        ...
                        <li class="nav-item dropdown pe-3 ">
                            ...
                            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                                ...
                                <img src="images/user.avif" height="25px" width="25px" alt="Profile" class="rounded-circle">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="userlogout.php">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
                        ...
                        <p class="mb-5"> Far removed from the hustle and bustle of everyday life, Treeland beckons you to a
                            serene
                            escape. Here, amidst the lush landscapes and verdant surroundings, our haven is a harmonious
                            blend of
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-7">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">Far, far away from the ordinary, beyond the concrete
                            jungles,
                            Treeland stands as an oasis near the majestic Chitwan National Park. It's a retreat where the
                            rhythmic flow
                            of the nearby river harmonizes with the melodies of the jungle, creating a symphony of serenity.
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <a href="#" class="room">
                            ...
                            <div class="p-3 text-center room-info">
                                ...
                                <span>
                                    <a class="nav-link" href="#section-rooms"><span
                                            class="btn btn-primary text-white font-weight-bold" data-toggle="modal"
                                            data-target="#reservation-form">Reserve Now</span></a></li>
                                </span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-7">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">Separated from the chaos, our haven resides in the heart
                            of
                            tranquility, akin to Bookmarksgrove, where the air is filled with the essence of adventure and
                            exploration.
                            At Treeland, you're invited to embark on a journey into the heart of nature, where every corner
                            is a
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="home-slider major-caousel owl-carousel mb-3 pb-5" data-aos="fade-up"
                            data-aos-delay="200">
                            ...
                            <div class="slider-item">
                                ...
                                while ($row = mysqli_fetch_array($run)) {
                                    ...
                                    $b = $row['slider2'];
                                    ?>
                                    <a href="images/<?php echo $b ?>" data-fancybox="images" data-caption=""><img
                                            src="images/<?php echo $b ?>" alt="Image placeholder" class="img-fluid"></a>
                                    <?php
                                }
                                ?>
                            </div>
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-7">
                        ...
                        <p class="text-white" data-aos="fade" data-aos-delay="100">Savor the flavors of our diverse
                            restaurant menu,
                            featuring a blend of local and international cuisines. Each dish is crafted with care, promising
                            a
                    ...
                    <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active letter-spacing-2" id="mains-tab" data-toggle="tab" href="#mains"
                                role="tab" aria-controls="mains" aria-selected="true">Food</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">Enjoy our tender chicken, simmered in a rich,
                                            aromatic gravy. A
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">A traditional Nepalese dish, featuring hearty
                                            lentil soup (Dal)
                                            served with fluffy rice (Bhat). A comforting, nutritious staple that embodies
                                            the essence of
                                            Nepalese cuisine.</p>
                                    </div>
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">Savor the unique flavors of Gonghi, a local
                                            delicacy that offers
                                            a true taste of Nepalese cuisine. A must-try for food enthusiasts seeking an
                                            authentic culinary
                                            experience.</p>
                                    </div>
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">Savor the bold flavors of our Chinese classics,
                                            like the fiery
                                            Kung Pao Chicken, crispy Vegetable Spring Rolls, and aromatic Fried Rice — a
                                            symphony of sweet,
                                ...
                                <div class="col-md-6">
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">Indulge in sophistication with our Grilled
                                            Salmon, Spaghetti
                                            Bolognese, and Chicken Piccata — a fusion of textures and tastes crafted with
                                            European charm.
                                        </p>
                                    </div>
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">Our traditional Dal Bhat served with succulent
                                            mutton. A perfect
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7"> Delight in the unique taste of Gundruk, a
                                            traditional Nepalese
                                            dish made from fermented and dried leafy vegetables. Its distinctive sour flavor
                                            offers a true
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <p class="text-white text-opacity-7">"Bhatmas Sadeko: A traditional Nepali
                                            appetizer, this dish
                                            features roasted soybeans tossed with a medley of spices. High in protein and
                                            packed with flavor,
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <h3 class="text-white"><a href="#" class="text-white">Coke, Diet Coke, Coke Zero</a>
                                        </h3>
                                        <p class="text-white text-opacity-7">Far far away, behind the word mountains, far
                                            from the countries
                                            Vokalia and Consonantia, there live the blind texts.</p>
                                ...
                                <div class="col-md-6">
                                    <div class="food-menu mb-5">
                                        ...
                                        <h3 class="text-white"><a href="#" class="text-white">Lemonade, Lemon Squash</a>
                                        </h3>
                                        <p class="text-white text-opacity-7">Far far away, behind the word mountains, far
                                            from the countries
                                            Vokalia and Consonantia, there live the blind texts.</p>
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <h3 class="text-white"><a href="#" class="text-white">Sparkling Mineral Water</a>
                                        </h3>
                                        <p class="text-white text-opacity-7">Far far away, behind the word mountains, far
                                            from the countries
                                            Vokalia and Consonantia, there live the blind texts.</p>
                                    ...
                                    <div class="food-menu mb-5">
                                        ...
                                        <h3 class="text-white"><a href="#" class="text-white">Lemon, Lime &amp; Bitters</a>
                                        </h3>
                                        <p class="text-white text-opacity-7">Far far away, behind the word mountains, far
                                            from the countries
                                            Vokalia and Consonantia, there live the blind texts.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="media media-custom d-block mb-4 h-100">
                            <img src="images/event1.jfif" alt="Image placeholder" class="img-fluid">
                            <div class="media-body">
                                <span class="meta-post">February 26, 2018</span>
                                <h2 class="mt-0 mb-3">Tharu Cultural Program</h2>
                                <p>Dive into our Tharu Cultural Program! Experience rich traditions, vibrant dances, and
                                    captivating
                                    music. A mesmerizing journey into Nepal’s heritage awaits you!</p><a
                                    href="events.php#event1">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
                        <div class="media media-custom d-block mb-4 h-100">
                            <img src="images/event5.jpg " alt="Image placeholder" class="img-fluid"></a>
                            <div class="media-body">
                                <span class="meta-post">February 26, 2018</span>
                                <h2 class="mt-0 mb-3">Elephant Ride</h2>
                                <p>Experience the thrill of our Elephant Ride event! Journey through scenic landscapes atop
                                    these gentle
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
                        <div class="media media-custom d-block mb-4 h-100">
                            <img src="images/event4.jfif" alt="Image placeholder" class="img-fluid">
                            <div class="media-body">
                                <span class="meta-post">February 26, 2018</span>
                                <h2 class="mt-0 mb-3">Jeep Safari</h2>
                                <p>Join our thrilling Jeep Safari event! Traverse rugged terrains, encounter diverse
                                    wildlife, and soak in
                    ...
                    <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
                        <div class="row">
                            <div class="col-md-10 ml-auto contact-info">
                                <p><span class="d-block">Address:</span> <span class="text-black">Chitwan National Park,
                                        Sauraha
                                        NepaL</span></p>
                                <p><span class="d-block">Phone:</span> <span class="text-black"> (+977) 984 552 3406</span>
                                </p>
        ...
        <div id="reviews" class="container">
            <h2 class="display-4">Customer Reviews:</h2>
        </div>
        ...
        while ($row = mysqli_fetch_array($run)) {
            ...
            <div class="container">
                ...
                <div class="row" style="margin:20px 0px; border:2px solid gray;">
                    <div class="col-sm-2"
                        style="text-transform:uppercase; display:block; background-color:#000; padding:10px; font-size:12px; font-weight:bold; color:#fff; text-align:center; border:2px solid gray;">
                        <?php echo $b; ?>
                    </div>
                    <div class="col-sm-6"
                        style="text-transform:uppercase; display:block; background-color:gray; padding:10px; font-size:12px; font-weight:bold; color:#fff; border:2px solid gray;">
                        <?php echo $d; ?>
                    </div>
                    <div class="col-sm-2"
                        style="text-transform:uppercase; display:block; background-color:gray; padding:10px; font-size:12px; font-weight:bold; color:#fff; border:2px solid gray;">
                    ...
                    <div class="col-sm-2"
                        style="text-transform:uppercase; display:block; background-color:black; padding:10px; font-size:12px; font-weight:bold; color:#fff; border:2px solid gray;">
                        <?php
                        if ($e == 1) {
                            ?>
        ...
        <div class="container" style="padding:10px">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="comment" id="content" rows="3" placeholder="Comment"
                        required></textarea>
                </div>
                <div class="form-group">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($run) {
                    ...
                    echo "<script>window.open('#reviews','_self')</script>";
            ...
            <div class="container">
                ...
                <div class="row pt-5">
                    <p class="col-md-8 text-left">
                        ...
                        Copyright &copy;
                        <script>document.write(new Date().getFullYear());</script> All rights reserved Tree Land Lodge |
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            <strong>Cancellation Policy:</strong> Cancellations must be made at least 48 hours prior to the
                            check-in
                            date to avoid charges. Late cancellations and no-shows will be charged for the first night.
                        </p>
                        <p>
                            <strong>Check-in/Check-out:</strong> Check-in time is 2:00 PM, and check-out time is 11:00 AM.
                            Early
        ...
        <div class="modal fade" id="privacyModal" tabindex="-1" role="dialog" aria-labelledby="privacyModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            <strong>Information Collection:</strong> We collect personal information, including your name,
                            contact
                        ...
                        <p>
                            <strong>Security:</strong> We prioritize the security of your data and have implemented measures
                            to
                            ...
                            <div class="col-md-12" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <form action="reservation.php" method="post" class="bg-white p-4">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12 form-group">
                                            <label for="message">Write Message</label>
                                            <textarea name="message" name="message" id="message" class="form-control "
